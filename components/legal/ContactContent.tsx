    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-gray-600">We&apos;re here to help. Reach out to us through any of the channels below.</p>
            </div>
            ...
            <div>
                ...
                <p className="text-sm text-gray-600 mt-2">{dealerName} — {fullAddress ?? location}</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <a
                    ...
                    className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-green-700 hover:bg-green-800 text-white text-sm font-semibold transition-colors"
                >
