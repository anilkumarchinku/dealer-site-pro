            ...
            <div className="p-4">
                <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                        ...
                        <p className="mt-1 truncate text-xs text-muted-foreground">{vehicle.year} · {vehicle.km_driven.toLocaleString("en-IN")} km · {vehicle.no_of_owners} owner{vehicle.no_of_owners > 1 ? "s" : ""}</p>
                    </div>
