        ...
        <div className="min-h-screen bg-white text-gray-900 font-serif">
                ...
                <div className="max-w-7xl mx-auto px-4 py-4">
                    <div className="flex items-center justify-between gap-4">
                        ...
                        <div className="hidden xl:flex flex-1 items-center justify-center gap-4 px-4 2xl:gap-8">
                            ...
                            <button onClick={() => navigateTo('contact')} className="whitespace-nowrap text-sm tracking-wider text-gray-600 hover:text-gray-900">Contact</button>
                            ...
                            <button onClick={() => navigateTo('exchange-section')} className="whitespace-nowrap text-sm tracking-wider text-gray-600 hover:text-gray-900">Exchange</button>
                            <button onClick={() => navigateTo('finance-section')} className="whitespace-nowrap text-sm tracking-wider text-gray-600 hover:text-gray-900">Finance</button>
                            <button onClick={() => navigateTo('service-section')} className="whitespace-nowrap text-sm tracking-wider text-gray-600 hover:text-gray-900">Service</button>
                    ...
                    {mobileMenuOpen && (
                        <div className="xl:hidden border-t border-gray-200 bg-white/95 backdrop-blur-lg animate-fade-in-down">
                            <div className="px-4 py-3 space-y-1">
                                ...
                                <button onClick={() => mobileNavigateTo('exchange-section')} className="block w-full text-left px-3 py-2.5 rounded-lg text-sm tracking-wider text-gray-900 hover:bg-gray-100 transition-colors">Exchange</button>
                                <button onClick={() => mobileNavigateTo('finance-section')} className="block w-full text-left px-3 py-2.5 rounded-lg text-sm tracking-wider text-gray-900 hover:bg-gray-100 transition-colors">Finance</button>
                                <button onClick={() => mobileNavigateTo('service-section')} className="block w-full text-left px-3 py-2.5 rounded-lg text-sm tracking-wider text-gray-900 hover:bg-gray-100 transition-colors">Service</button>
                                ...
                                {sellVehicleHref && (
                                    <a href={sellVehicleHref} className="block w-full px-3 py-2.5 rounded-lg text-sm tracking-wider text-gray-900 hover:bg-gray-100 transition-colors">
                                        Sell Your Car
                                    </a>
                                )}
            ...
            {activeTab === 'home' && (
                <>
                    ...
                    {/* Offers Section */}
                    <OffersSection brandColor={brandAccent} dealerName={dealerName} vehicleType={vehicleType} dealerPhone={contactInfo.phone} dealerOffers={dealerOffers} templateStyle="luxury" />
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center mb-8 pb-6 border-b border-gray-200">
                        ...
                        <div className="min-w-0">
                            <span className="block break-words text-2xl font-light tracking-widest text-gray-900">{dealerName}</span>
                            <span className="text-sm text-gray-600">{tagline}</span>
                        </div>
                    </div>

                    <div className={`grid gap-8 text-gray-600 ${branches && branches.length > 0 ? 'md:grid-cols-4' : 'md:grid-cols-3'}`}>
                        <div>
                            <h4 className="text-gray-900 font-light text-lg mb-4">Contact</h4>
                            <div className="space-y-2">
                                <div className="flex min-w-0 items-center gap-2"><Phone className="w-4 h-4 shrink-0" style={{ color: brandAccent }} /><a className="min-w-0 break-words" href={`tel:${contactInfo.phone}`}>{contactInfo.phone}</a></div>
                                <div className="flex min-w-0 items-center gap-2"><Mail className="w-4 h-4 shrink-0" style={{ color: brandAccent }} /><a className="min-w-0 break-all" href={`mailto:${contactInfo.email}`}>{contactInfo.email}</a></div>
                                <div className="flex min-w-0 items-start gap-2"><MapPin className="w-4 h-4 mt-1 shrink-0" style={{ color: brandAccent }} /><span className="min-w-0 break-words">{contactInfo.address}</span></div>
                                {workingHours && (
