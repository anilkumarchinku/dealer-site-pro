                                ...
                                <div className="rounded-lg border-2 border-gray-200 p-8 bg-white shadow-sm">
                                    {formStatus === 'sent' ? (
                                        ...
                                        <form onSubmit={handleSubmit} className="space-y-4">
                                            ...
                                            <div>
                                                <label className="block text-xs font-black uppercase tracking-widest text-gray-600 mb-2">Name *</label>
                                                <input
                                                    type="text"
                                                    required
                                                    value={formData.name}
                                            ...
                                            <div>
                                                <label className="block text-xs font-black uppercase tracking-widest text-gray-600 mb-2">Phone *</label>
                                                <input
                                                    type="tel"
                                                    required
                                            ...
                                            <div>
                                                <label className="block text-xs font-black uppercase tracking-widest text-gray-600 mb-2">Email</label>
                                                <input
                                                    type="email"
                                            ...
                                            <div>
                                                <label className="block text-xs font-black uppercase tracking-widest text-gray-600 mb-2">{vl.whichVehicle}</label>
                                                <textarea
                                                    rows={4}
