...
export function TestDriveModal({
    ...
    const imageCategory = (vehicleType ?? car.vehicleCategory ?? '4w') as '2w' | '3w' | '4w';
    const heroSrc = getVehicleImageUrls(
        imageCategory,
                            ...
                            <div className="flex gap-2">
                                {whatsappMsg && (
                                    <a
                                        ...
                                        className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-green-700 hover:bg-green-800 text-white text-sm font-semibold transition-colors"
                                    >
