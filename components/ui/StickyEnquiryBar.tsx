...
function getTestDriveLabel(vehicleType?: '2w' | '3w' | '4w') {
            ...
            <div className="bg-white pb-4 pt-2 px-2">
                <div className="grid grid-cols-4 gap-1.5">
                    ...
                    <a
                        ...
                        className="flex flex-col items-center justify-center gap-1 py-2.5 rounded-xl bg-white border border-gray-200 text-[#25D366] hover:bg-gray-50 active:scale-95 transition-transform"
                    >
