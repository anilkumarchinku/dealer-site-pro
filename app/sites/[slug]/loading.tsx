export default function SiteLoading() {
    return (
        <div className="min-h-screen bg-white animate-pulse">
            ...
            {/* Hero skeleton */}
            <div className="h-96 bg-gray-100 flex flex-col items-center justify-center gap-4 px-6">
                <div className="h-8 w-64 rounded-xl bg-gray-200" />
                <div className="h-5 w-96 max-w-full rounded-xl bg-gray-200" />
                <div className="h-5 w-80 max-w-full rounded-xl bg-gray-200" />
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                <div className="h-7 w-48 rounded-xl bg-gray-200 mb-8" />
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {Array.from({ length: 8 }).map((_, i) => (
                        <div key={i} className="rounded-xl border border-gray-200 overflow-hidden">
                            <div className="h-48 bg-gray-200" />
                            <div className="p-4 space-y-3">
                                <div className="h-5 w-3/4 rounded-xl bg-gray-200" />
