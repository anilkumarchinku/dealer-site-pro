        ...
        <div className="min-h-screen max-w-5xl mx-auto px-4 py-8">
            ...
            {vehicles.length === 0 ? (
                <div className="text-center py-20 text-muted-foreground">
                    ...
                    <p className="text-lg font-medium mt-4">No cargo vehicles available right now</p>
                    <p className="text-sm mt-1">Contact us for custom requirements or fleet orders.</p>
                </div>
            ) : (
