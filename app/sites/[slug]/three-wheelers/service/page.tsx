...
export default function ThreeWheelerServicePage() {
    ...
    const services = [
        ...
        { emoji: "🔵", name: "CNG Kit Service",   desc: "CNG kit inspection and repair"       },
        { emoji: "🔨", name: "Body Work",         desc: "Denting, painting, fabrication"      },
        { emoji: "💡", name: "Electrical Work",   desc: "Wiring, lights, indicators"          },
        ...
        <div className="min-h-screen">
            <div className="max-w-4xl mx-auto px-4 py-10">
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground mt-2">Schedule a service appointment for your 3-wheeler at our workshop.</p>
                </div>
