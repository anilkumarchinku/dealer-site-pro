...
export default function TwoWheelerStep4Page() {
    ...
    const [config, setConfig] = useState(() => getPrefilledTemplateConfig(data, "two-wheeler"));
    const [urlErrors, setUrlErrors] = useState<Record<string, string>>({});

    useEffect(() => { setStep(4); }, [setStep]);

    useEffect(() => {
        setConfig(getPrefilledTemplateConfig(data, "two-wheeler"));
    }, [data]);
    ...
    const handleNext = () => {
        ...
        updateData({ templateConfig: { ...data.templateConfig, ...config } });
        setStep(5);
        router.push("/onboarding/two-wheelers/step-5");
    };
        ...
        <div className="space-y-6 animate-fade-in">
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid gap-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="heroTitle"
                                    placeholder="e.g. Find Your Perfect Ride Today"
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="heroSubtitle"
                                    placeholder="e.g. Best deals on new and used bikes in [City]"
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="heroCtaText"
                                    placeholder="e.g. View Our Bikes"
                    ...
                    <div className="space-y-4 pt-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="featuresTitle"
                                placeholder="e.g. Why Ride With Us?"
                    ...
                    <SocialLinksFields
                        ...
                        placeholders={{
                            facebook:  "https://facebook.com/yourbikeshop",
                            instagram: "https://instagram.com/yourbikeshop",
                            twitter:   "https://x.com/yourbikeshop",
                ...
                <CardFooter className="justify-between">
                    <Button variant="ghost" onClick={() => router.push("/onboarding/two-wheelers/step-3")}>
            ...
            <div className="rounded-xl p-4 flex gap-3 border border-primary/20 bg-primary/5">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        All text can be edited any time from your dashboard after launch!
                    </p>
                </div>
            </div>
        </div>
