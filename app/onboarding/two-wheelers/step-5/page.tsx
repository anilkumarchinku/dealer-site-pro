...
export default function TwoWheelerStep5Page() {
    ...
    const handleFinish = async () => {
        ...
        setSaveError(null);
        try {
            const result = await saveDealer(data, dealerId ?? undefined, 'two-wheeler');
            if (result.success) {
    ...
    const handleCopyUrl = () => {
        ...
        navigator.clipboard.writeText(dealerVehicleSiteHref(liveSiteSlug, 'two-wheeler')).then(() => {
            setCopied(true);
    ...
    if (showSuccess) {
        const liveUrl  = liveSiteSlug ? dealerVehicleSiteUrl(liveSiteSlug, 'two-wheeler') : null;
        const liveHref = liveSiteSlug ? dealerVehicleSiteHref(liveSiteSlug, 'two-wheeler') : null;
        return (
                    ...
                    <CardContent className="p-8 text-center space-y-6">
                        ...
                        <div className="space-y-2">
                            <h1 className="text-2xl font-bold text-foreground">
                                Your Dealership Website is Live! 🏍️
                            </h1>
        ...
        <div className="space-y-6 animate-fade-in">
            <Card>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="rounded-lg px-3 py-2 border border-primary/30 bg-background font-mono text-sm text-primary break-all">
                                        {dealerVehicleSiteUrl(data.slug || data.dealershipName?.toLowerCase().replace(/\s+/g, "-").replace(/[^a-z0-9-]/g, "") || "", 'two-wheeler')}
                                    </div>
                ...
                <CardFooter className="justify-between">
                    <Button variant="ghost" onClick={() => router.push("/onboarding/two-wheelers/step-4")} disabled={saving}>
                    ...
                    <div className="max-w-md mx-auto">
                        <Card className="border-2 border-primary/30 hover:border-primary/60 transition-colors relative overflow-hidden">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    {[
                                        "Use your existing domain (e.g. mybikes.com)",
