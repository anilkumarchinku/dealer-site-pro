...
function getBackHref(pathname: string) {
    if (pathname.includes("step-5")) return "/onboarding/two-wheelers/step-4";
    if (pathname.includes("step-4")) return "/onboarding/two-wheelers/step-3";
    if (pathname.includes("step-3")) return "/onboarding/two-wheelers/step-2";
    if (pathname.includes("step-2")) return "/onboarding/two-wheelers/step-1";
    return "/onboarding";
}
