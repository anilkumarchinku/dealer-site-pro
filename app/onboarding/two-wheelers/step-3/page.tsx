...
const TEMPLATES: { id: StyleTemplate; name: string; description: string; preview: { bg: string; accent: string } }[] = [
    {
        id: "luxury",
        name: "Modern",
        description: "Clean, minimal layout with bold typography. Great for premium brands.",
        preview: { bg: "from-slate-900 to-slate-800", accent: "bg-blue-500" },
    },
    {
        id: "family",
        name: "Classic",
        description: "Warm, trustworthy design that appeals to everyday riders.",
        preview: { bg: "from-orange-50 to-white", accent: "bg-orange-500" },
    },
    {
        id: "sporty",
        name: "Sporty",
        description: "Bold, energetic design for performance and adventure bikes.",
        preview: { bg: "from-red-900 to-gray-900", accent: "bg-red-500" },
    },
    {
        id: "professional",
        name: "Professional",
        description: "Corporate-grade layout for multi-brand and fleet dealers.",
        preview: { bg: "from-gray-100 to-white", accent: "bg-gray-800" },
    },
];

export default function TwoWheelerStep3Page() {
    ...
    const handleNext = () => {
        ...
        setStep(4);
        router.push("/onboarding/two-wheelers/step-4");
    };
        ...
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <div className="sticky bottom-0 border-t bg-background/95 backdrop-blur">
                <div className="container max-w-4xl mx-auto px-8 py-4 flex justify-between items-center">
                    <Button variant="ghost" onClick={() => router.push("/onboarding/two-wheelers/step-2")}>
