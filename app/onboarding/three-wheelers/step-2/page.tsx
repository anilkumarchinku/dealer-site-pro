...
const SERVICES: { id: Service; icon: string; title: string; description: string }[] = [
    ...
    { id: "express_service",      icon: "⚡", title: "Express Service",          description: "Quick servicing and fast turnaround"         },
    { id: "extended_warranties",  icon: "🛡️", title: "AMC & Warranty",          description: "Annual maintenance contracts and warranties" },
    { id: "fleet_sales",          icon: "🏢", title: "Fleet Sales",             description: "Bulk sales for businesses and operators"    },
    { id: "get_callback",         icon: "📞", title: "Get a Callback",          description: "Request a call from our sales team"          },
    { id: "home_test_drives",     icon: "🏠", title: "Free Demo Ride",          description: "Offer demo rides to potential buyers"        },
];

export default function ThreeWheelerStep2Page() {
    ...
    return (
        <Card className="animate-fade-in">
            <CardHeader>
                ...
                <CardDescription>
                    {isBoth
                        ...
                        : isUsed
                            ? "Tell us what you offer — we'll build pages tailored for pre-owned buyers"
            ...
            <CardFooter className="justify-between">
                <Button variant="ghost" onClick={() => router.push("/onboarding/three-wheelers/step-1")}>
