...
import { Sparkles, Building2, RefreshCw, ArrowRight, ArrowLeft } from "lucide-react";
...
const DEALER_TYPES = [
    {
        id: "new" as const,
        emoji: "🛺",
        label: "New Three-Wheelers",
        sublabel: "Authorised Dealer",
        description: "Sell brand-new passenger autos, cargo vehicles, or electric three-wheelers.",
        features: ["Model showcase", "OEM brand pages", "Lead generation"],
        color: "green",
    },
    {
        id: "used" as const,
        emoji: "🔄",
        label: "Used Three-Wheelers",
        sublabel: "Pre-Owned",
        description: "Sell pre-owned autos and three-wheelers from your own stock.",
        features: ["Stock listing", "Verified badge", "Enquiry forms"],
        color: "amber",
    },
    {
        id: "both" as const,
        ...
        description: "Sell both new and pre-owned three-wheelers from one dealership.",
...
const colorStyles: Record<string, { border: string; bg: string; text: string; badge: string }> = {
    green:  { border: "border-green-500/40 hover:border-green-500/80",   bg: "hover:bg-green-500/5",  text: "text-green-600 dark:text-green-400",   badge: "bg-green-500/10 text-green-700 border-green-500/20"   },
...
export default function ThreeWheelerIndexPage() {
    ...
    const handleSelect = (category: "new" | "used" | "both") => {
        ...
        setSellsTwoWheelers(false);
        setSellsThreeWheelers(true);
        updateData({
        ...
        router.push("/onboarding/three-wheelers/step-1");
    };
                ...
                <div className="w-full max-w-3xl mx-auto space-y-10">
                    ...
                    <div className="text-center space-y-4">
                        <div className="inline-flex items-center gap-2 text-xs font-medium px-3 py-1.5 rounded-full bg-primary/10 text-primary border border-primary/20">
                            ...
                            Three-Wheeler Dealership Setup
                        </div>
                        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground">
                            What type of three-wheeler dealer are you?
                        </h1>
