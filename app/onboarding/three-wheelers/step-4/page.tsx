...
export default function ThreeWheelerStep4Page() {
    ...
    const handleNext = () => {
        setStep(5);
        router.push("/onboarding/three-wheelers/step-5");
    };
        ...
        <div className="space-y-6 animate-fade-in">
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid gap-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="heroTitle"
                                    placeholder="e.g. Your Trusted Auto Partner"
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="heroSubtitle"
                                    placeholder="e.g. Best deals on new and used autos in [City]"
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    id="heroCtaText"
                                    placeholder="e.g. View Our Vehicles"
                    ...
                    <div className="space-y-4 pt-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="featuresTitle"
                                placeholder="e.g. Why Choose Our Dealership?"
                    ...
                    <div className="space-y-4 pt-4">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Input
                                    placeholder="https://facebook.com/yourshowroom"
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    placeholder="https://instagram.com/yourshowroom"
                            ...
                            <div className="space-y-2 sm:col-span-2">
                                <Label>YouTube</Label>
                                <Input
                                    placeholder="https://youtube.com/@yourshowroom"
                ...
                <CardFooter className="justify-between">
                    <Button variant="ghost" onClick={() => router.push("/onboarding/three-wheelers/step-3")}>
