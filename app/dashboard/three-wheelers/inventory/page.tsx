...
function InventoryModelImage({ vehicle }: { vehicle: ThreeWheelerVehicle }) {
    const brandId = brandNameToId(vehicle.brand, "3w")
    const uploaded = vehicle.images.find(isUsableVehicleImageUrl)
    const imageUrls = [
        ...getVehicleImageUrls("3w", brandId, vehicle.model),
        ...(uploaded ? [uploaded] : []),
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold">New 3W Inventory</h1>
            ...
            {loading ? (
                ...
                <div className="text-center py-20 text-muted-foreground">
                    ...
                    <p className="text-sm mb-6">Add your first 3-wheeler to get started.</p>
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex items-center gap-2 mt-3">
                                    <Button variant="outline" size="sm" asChild className="flex-1">
                                        <Link href={`/dashboard/three-wheelers/inventory/${v.id}/edit`}>
