...
export default function AddUsedTwoWheelerPage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            const res = await fetch("/api/two-wheelers/used", {
                method:  "POST",
            ...
            router.push("/dashboard/two-wheelers/used")
        } catch (err) {
    ...
    return (
        <div className="max-w-2xl space-y-6">
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-2xl font-bold">Add Used Vehicle</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                <fieldset className="bg-card border border-border rounded-xl p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" value={form.km_driven} onChange={e => set("km_driven", e.target.value)} placeholder="15000" className="mt-1 w-full rounded-lg border border-input bg-background px-3 py-2 text-sm" />
                        </div>
                        <div>
                ...
                <fieldset className="bg-card border border-border rounded-xl p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <VehicleImageUpload value={images} onChange={setImages} maxImages={5} />
                    </div>
                    <div>
