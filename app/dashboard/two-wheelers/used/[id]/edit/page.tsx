...
export default function EditUsedTwoWheelerPage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            const res = await fetch(`/api/two-wheelers/used/${id}`, {
                method:  "PUT",
    ...
    return (
        <div className="max-w-2xl space-y-6">
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-2xl font-bold">Edit Used Vehicle</h1>
            </div>
