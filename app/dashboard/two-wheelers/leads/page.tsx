...
const STATUSES: TwoWheelerLeadStatus[] = ["new", "contacted", "converted", "lost"]

export default function TwoWheelerLeadsPage() {
    const { dealerId } = useOnboardingStore()
    const [leads, setLeads] = useState<TwoWheelerLead[]>([])
    ...
    const load = useCallback(async () => {
        ...
        try {
            ...
            const res  = await fetch(`/api/two-wheelers/leads?${params}`)
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold">2W Leads</h1>
            ...
            {loading ? (
                ...
                <div className="text-center py-20 text-muted-foreground">
                    ...
                    <p className="text-sm mt-1">Leads from your public 2W site will appear here.</p>
                </div>
            ) : (
