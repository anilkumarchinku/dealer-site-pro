                ...
                <fieldset className="bg-card border border-border rounded-xl p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="col-span-1">
                            ...
                            <input value={form.brand} onChange={e => set("brand", e.target.value)} placeholder="e.g. Hero" className="mt-1 w-full rounded-lg border border-input bg-background px-3 py-2 text-sm" />
                        </div>
                        <div className="col-span-1">
                            <label className="text-sm font-medium">Model *</label>
                            <input value={form.model} onChange={e => set("model", e.target.value)} placeholder="e.g. Splendor Plus" className="mt-1 w-full rounded-lg border border-input bg-background px-3 py-2 text-sm" />
                        </div>
                        <div className="col-span-1">
