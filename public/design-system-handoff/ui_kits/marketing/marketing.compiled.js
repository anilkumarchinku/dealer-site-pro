(() => {
  // public/design-system-handoff/ui_kits/marketing/data.jsx
  var U = (id, w = 800) => `https://images.unsplash.com/photo-${id}?auto=format&fit=crop&w=${w}&q=72`;
  var DSP_MARKETPLACE_PREVIEW_ENDPOINT = "/api/marketplace?pageSize=48&category=all&condition=new";
  var DSP_PREVIEW_FALLBACK_IMAGES = {
  ...
  var DSP_PREVIEW_NEW_VEHICLE_IMAGES = [
  ...
  var DSP_PREVIEW_TWO_WHEELER_BRANDS = [
    "ather",
    "bajaj",
    "hero",
    "honda motorcycles",
  ...
  // public/design-system-handoff/ui_kits/marketing/icons.jsx
  var Svg = ({ size = 24, children, style }) => /* @__PURE__ */ React.createElement(
    "svg",
    {
      width: size,
      height: size,
  ...
  // public/design-system-handoff/ui_kits/marketing/Reveal.jsx
  ...
  // public/design-system-handoff/ui_kits/marketing/Layout.jsx
  ...
  // public/design-system-handoff/ui_kits/marketing/DealerPreview.jsx
  var DSP_THEMES = {
  ...
  // public/design-system-handoff/ui_kits/marketing/Elevate.jsx
  ...
  // public/design-system-handoff/ui_kits/marketing/Header.jsx
  ...
  function VehicleMarketTopNav({ mode, setMode }) {
    ...
    ), /* @__PURE__ */ React.createElement("button", { type: "button", className: "dsp-market-topnav-link", onClick: () => emitVehicleFilter("type", "Bikes") }, /* @__PURE__ */ React.createElement(window.Icons.bike, { size: 17 }), " Bikes"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "dsp-market-topnav-link", onClick: () => emitVehicleFilter("type", "Autos") }, /* @__PURE__ */ React.createElement(window.Icons.auto, { size: 17 }), " Autos"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "dsp-market-topnav-link", onClick: () => scrollToMarketingSection("brands") }, "Brands"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "dsp-market-topnav-cta", onClick: () => {
      window.top.location.href = "/onboarding";
    } }, "Create My Website ", /* @__PURE__ */ React.createElement(window.Icons.arrowRight, { size: 16 }))))), menuOpen ? /* @__PURE__ */ React.createElement(VehicleMarketMegaMenu, { closeMenu: () => setMenuOpen(false) }) : null);
  }
  ...
  function FloatBubble({ style }) {
    ...
    const vehicleLabel = vehicles[0]?.name ? `${vehicles[0].name} \xB7 test drive` : "DB vehicle \xB7 test drive";
  ...
  // public/design-system-handoff/ui_kits/marketing/Search.jsx
  function SearchDiscover() {
    ...
    })), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 10, marginTop: 2 } }, /* @__PURE__ */ React.createElement("a", { href: detailHref, target: "_top", style: { flex: 1, display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 7, height: 44, borderRadius: "var(--radius-md)", background: "var(--ink-900)", color: "var(--cream-50)", fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", fontWeight: 700, textDecoration: "none" } }, "View full details"), /* @__PURE__ */ React.createElement("a", { href: enquiryHref, target: "_top", style: { flex: "none", display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 7, height: 44, padding: "0 18px", borderRadius: "var(--radius-md)", background: "var(--surface-card)", border: "1px solid var(--border-default)", color: "var(--text-strong)", fontFamily: "var(--font-body)", fontSize: "var(--text-sm)", fontWeight: 700, textDecoration: "none" } }, /* @__PURE__ */ React.createElement(window.Icons.whatsapp, { size: 16 }), " Enquire")))) : /* @__PURE__ */ React.createElement("div", { style: { padding: 34, textAlign: "center", borderTop: "1px solid var(--border-subtle)", color: "var(--text-muted)", fontFamily: "var(--font-body)", fontWeight: 700 } }, status === "loading" ? "Loading a vehicle result from the database..." : "No database vehicle is available for this search preview yet.")))));
  }
  window.SearchDiscover = SearchDiscover;

  // public/design-system-handoff/ui_kits/marketing/SectionsMid.jsx
  ...
  // public/design-system-handoff/ui_kits/marketing/Pricing.jsx
  var DSP_PRICING = [
    {
      name: "Starter",
      price: "\u20B90",
  ...
  // public/design-system-handoff/ui_kits/marketing/SectionsEnd.jsx
  ...
  // public/design-system-handoff/ui_kits/marketing/VehicleExplorer.jsx
  var DSP_MARKETPLACE_PAGE_SIZE = 48;
  var DSP_MARKETPLACE_ENDPOINT = `/api/marketplace?pageSize=${DSP_MARKETPLACE_PAGE_SIZE}&category=all&condition=new`;
  var DSP_BRAND_ALIASES = {
  ...
  function VrfBrandLogo({ name, category = "" }) {
    ...
    return /* @__PURE__ */ React.createElement("span", { className: "vrf-brand-fallback" }, brandInitials(name));
  }
  var VRF_BRAND_DIRECTORY_TYPES = [
  ...
  function VrfBrandDirectoryCard({ brand }) {
    return /* @__PURE__ */ React.createElement("a", { href: brand.href, target: "_top", className: "vrf-directory-card" }, /* @__PURE__ */ React.createElement("span", { className: "vrf-directory-logo" }, /* @__PURE__ */ React.createElement(VrfBrandLogo, { name: brand.rawName, category: brand.category })), /* @__PURE__ */ React.createElement("h3", null, brand.name), /* @__PURE__ */ React.createElement("span", { className: "vrf-directory-count" }, brand.modelCount, " ", brand.modelCount === 1 ? "Model" : "Models"), /* @__PURE__ */ React.createElement("p", null, brand.priceRange), /* @__PURE__ */ React.createElement("span", { className: "vrf-directory-link" }, "Open brand page ", /* @__PURE__ */ React.createElement(window.Icons.arrowRight, { size: 12 })));
  }
  ...
  function VrfBrandRailCard({ brand }) {
    return /* @__PURE__ */ React.createElement("a", { href: brand.href, target: "_top", className: "vrf-brand-rail-card" }, /* @__PURE__ */ React.createElement("span", { className: "vrf-brand-rail-logo" }, /* @__PURE__ */ React.createElement(VrfBrandLogo, { name: brand.rawName, category: brand.category })), /* @__PURE__ */ React.createElement("span", { className: "vrf-brand-rail-name" }, brand.name), /* @__PURE__ */ React.createElement("span", { className: "vrf-brand-rail-meta" }, brand.modelCount, " ", brand.modelCount === 1 ? "model" : "models"));
  }
  function VrfBrandMarquee({ title, label, brands, direction = "clockwise" }) {
    if (!brands.length) return null;
    const loopBrands = [...brands, ...brands, ...brands];
    return /* @__PURE__ */ React.createElement("div", { className: "vrf-brand-marquee-row", "data-direction": direction }, /* @__PURE__ */ React.createElement("div", { className: "vrf-brand-marquee-label" }, /* @__PURE__ */ React.createElement("span", null, title), /* @__PURE__ */ React.createElement("strong", null, label)), /* @__PURE__ */ React.createElement("div", { className: "vrf-brand-marquee-viewport" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-brand-marquee-track" }, loopBrands.map((brand, index) => /* @__PURE__ */ React.createElement(VrfBrandRailCard, { key: `${title}-${brand.rawName}-${index}`, brand })))));
  }
  function VrfBrandCarouselShowcase({ vehicles, openAllBrands }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { id: "brands", className: "vrf-brand-rotator" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-section-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { color: "var(--bronze-400)", fontSize: 11, fontWeight: 950, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 6 } }, "Featured brand lanes"), /* @__PURE__ */ React.createElement("h2", null, "Browse by Brand"), /* @__PURE__ */ React.createElement("p", null, "A calmer brand preview: 4W and 2W glide forward, 3W moves the opposite way, and the full directory opens only when needed.")), /* @__PURE__ */ React.createElement("div", { className: "vrf-brand-actions" }, /* @__PURE__ */ React.createElement("span", null, totalBrands, " live brands"), /* @__PURE__ */ React.createElement("button", { type: "button", className: "vrf-link-button", onClick: () => openAllBrands("4w") }, "View all ", /* @__PURE__ */ React.createElement(window.Icons.chevronRight, { size: 12, style: { verticalAlign: "-2px" } })))), /* @__PURE__ */ React.createElement("div", { className: "vrf-brand-marquee-stack", "aria-label": "Featured vehicle brands" }, /* @__PURE__ */ React.createElement(VrfBrandMarquee, { title: "4W", label: "Cars", brands: brandGroups["4w"], direction: "clockwise" }), /* @__PURE__ */ React.createElement(VrfBrandMarquee, { title: "3W", label: "Autos", brands: brandGroups["3w"], direction: "anticlockwise" }), /* @__PURE__ */ React.createElement(VrfBrandMarquee, { title: "2W", label: "Bikes", brands: brandGroups["2w"], direction: "clockwise" })));
  }
  function VrfHero({
    vehicles,
    heroVehicle,
    ...
    return /* @__PURE__ */ React.createElement("section", { className: "vrf-hero" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-container" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-hero-grid" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-hero-copy" }, /* @__PURE__ */ React.createElement("span", { className: "vrf-kicker" }, /* @__PURE__ */ React.createElement(window.Icons.spark, { size: 13 }), " 2026 New Lineup"), /* @__PURE__ */ React.createElement("h1", null, /* @__PURE__ */ React.createElement("span", { className: "vrf-hero-line" }, "Find your"), " ", /* @__PURE__ */ React.createElement("span", { className: "vrf-hero-line" }, "brand-new ride"), " ", /* @__PURE__ */ React.createElement("span", { className: "vrf-hero-line" }, "with"), " ", /* @__PURE__ */ React.createElement("span", { className: "vrf-hero-line", style: { color: "var(--vrf-brand)" } }, "total clarity.")), /* @__PURE__ */ React.createElement("p", null, "Verified on-road pricing, direct dealer inventory, and zero-hassle discovery on live vehicles from your marketplace database."), /* @__PURE__ */ React.createElement("div", { className: "vrf-search-panel" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-tabs" }, tabs.map(([id, label]) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: id,
        type: "button",
      ...
      label
    ))), /* @__PURE__ */ React.createElement("div", { style: { padding: 16 } }, /* @__PURE__ */ React.createElement("div", { className: "vrf-chip-row" }, quickItems.slice(0, 8).map((item) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: item,
        type: "button",
      ...
      /* @__PURE__ */ React.createElement("button", { type: "submit", className: "vrf-primary" }, "Find Vehicles")
    ))), /* @__PURE__ */ React.createElement("div", { className: "vrf-proof-row" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(window.Icons.check, { size: 16, style: { color: "var(--vrf-success)" } }), " Verified on-road pricing"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(window.Icons.brands, { size: 16, style: { color: "var(--vrf-brand)" } }), " Dealer-backed inventory"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(window.Icons.spark, { size: 16, style: { color: "var(--vrf-warning)" } }), " ", vehicles.length, "+ live offers"))), /* @__PURE__ */ React.createElement("div", { className: "vrf-hero-media" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-hero-car" }, /* @__PURE__ */ React.createElement("img", { src: heroVehicle?.image || DSP_FALLBACK_IMAGES.car, alt: heroVehicle ? vrfModelLabel(heroVehicle) : "Featured new SUV" }), /* @__PURE__ */ React.createElement("div", { className: "vrf-float-pill", style: { left: 16, top: 16 } }, "Featured \xB7 ", heroVehicle?.year || "2026"), /* @__PURE__ */ React.createElement("div", { className: "vrf-float-pill", style: { right: 16, bottom: 16, display: "inline-flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement(window.Icons.gauge, { size: 14 }), " 360\xB0 View"), /* @__PURE__ */ React.createElement("div", { className: "vrf-float-card", style: { left: 16, bottom: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { color: "var(--vrf-muted)", fontSize: 10, fontWeight: 950, letterSpacing: "0.08em", textTransform: "uppercase" } }, "EMI from"), /* @__PURE__ */ React.createElement("div", { style: { color: "var(--vrf-success)", fontFamily: "var(--font-display)", fontSize: 24, fontWeight: 950 } }, heroVehicle?.emi || "Ask dealer")), /* @__PURE__ */ React.createElement("div", { className: "vrf-float-card", style: { right: 12, top: 66 } }, /* @__PURE__ */ React.createElement("div", { style: { color: "var(--vrf-muted)", fontSize: 10, fontWeight: 950, letterSpacing: "0.08em", textTransform: "uppercase" } }, "On-road"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 950 } }, heroVehicle?.onRoad || "Ask dealer")))))));
  }
  function VrfBrowseRails({ vehicles, budgets, bodies, brands, budget, body, brand, setBudget, setBody, selectBrand, openAllBrands }) {
    return /* @__PURE__ */ React.createElement("section", { className: "vrf-section" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-container vrf-rail-stack" }, /* @__PURE__ */ React.createElement("div", { id: "budget" }, /* @__PURE__ */ React.createElement(VrfSectionHead, { title: "Browse by Budget" }), /* @__PURE__ */ React.createElement("div", { className: "vrf-budget-grid" }, budgets.slice(0, 6).map((item) => /* @__PURE__ */ React.createElement("button", { key: item, type: "button", className: "vrf-rail-card", "data-active": budget === item, onClick: () => {
      setBudget(item);
      vrfScrollToListing();
    } }, /* @__PURE__ */ React.createElement("div", { className: "vrf-rail-label" }, "Budget"), /* @__PURE__ */ React.createElement("div", { className: "vrf-rail-value" }, item))))), /* @__PURE__ */ React.createElement("div", { id: "body" }, /* @__PURE__ */ React.createElement(VrfSectionHead, { title: "Browse by Body Type" }), /* @__PURE__ */ React.createElement("div", { className: "vrf-body-grid" }, bodies.slice(0, 7).map((item) => /* @__PURE__ */ React.createElement("button", { key: item, type: "button", className: "vrf-rail-card", "data-active": body === item, onClick: () => {
      setBody(item);
      vrfScrollToListing();
    }, style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement(window.Icons.car, { size: 30, style: { color: body === item ? "var(--vrf-brand)" : "var(--vrf-muted)" } }), /* @__PURE__ */ React.createElement("div", { className: "vrf-rail-value", style: { fontSize: 13 } }, item))))), /* @__PURE__ */ React.createElement(VrfBrandCarouselShowcase, { vehicles, openAllBrands })));
  }
  ...
  function VrfVehicleCard({ vehicle, compared, saved, onCompareToggle, onSaveToggle, onEnquire }) {
    ...
    return /* @__PURE__ */ React.createElement("article", { className: "vrf-vehicle-card" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-card-media" }, /* @__PURE__ */ React.createElement(
      "img",
      {
    ...
    ), /* @__PURE__ */ React.createElement("span", { className: "vrf-badge", "data-tone": vrfBadgeTone(vehicle) }, vehicle.badge), vehicle.offer ? /* @__PURE__ */ React.createElement("span", { className: "vrf-badge vrf-offer-badge", "data-tone": "warning" }, vehicle.offer) : null), /* @__PURE__ */ React.createElement("div", { className: "vrf-card-body" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-card-brand-row" }, /* @__PURE__ */ React.createElement("span", { className: "vrf-card-brand-logo" }, /* @__PURE__ */ React.createElement(VrfBrandLogo, { name: vehicle.brand, category: vehicle.category })), /* @__PURE__ */ React.createElement("span", { className: "vrf-card-brand" }, displayBrandName(vehicle.brand))), /* @__PURE__ */ React.createElement("h3", { className: "vrf-card-title" }, /* @__PURE__ */ React.createElement("a", { href: vehicle.detailHref, target: "_top" }, vehicle.name)), /* @__PURE__ */ React.createElement("p", { className: "vrf-card-sub" }, vehicle.variant), /* @__PURE__ */ React.createElement("div", { className: "vrf-price-block" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-card-price" }, vehicle.price, /* @__PURE__ */ React.createElement("small", null, " onwards")), /* @__PURE__ */ React.createElement("div", { className: "vrf-price-caption" }, "Ex-showroom price*"), /* @__PURE__ */ React.createElement("div", { className: "vrf-emi-pill" }, /* @__PURE__ */ React.createElement(window.Icons.arrowUpRight, { size: 14 }), " EMI ", vehicle.emi)), /* @__PURE__ */ React.createElement("div", { className: "vrf-spec-grid" }, specs.map((spec) => {
  ...
  function VrfListing(props) {
    ...
    const listingCountLabel = loadingVehicles && vehicles.length === 0 ? "Loading new vehicles" : `${filtered.length} new vehicles`;
    ...
    return /* @__PURE__ */ React.createElement("section", { id: "listing", className: "vrf-section vrf-listing" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-container" }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 32 } }, /* @__PURE__ */ React.createElement("h2", { style: { margin: 0, fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 4vw, 3.1rem)", lineHeight: 1, fontWeight: 950 } }, "All new vehicles"), /* @__PURE__ */ React.createElement("p", { style: { margin: "8px 0 0", color: "var(--vrf-muted)", fontSize: 14, fontWeight: 750 } }, listingMessage)), /* @__PURE__ */ React.createElement("div", { className: "vrf-listing-grid" }, /* @__PURE__ */ React.createElement(VrfFilterRail, { ...props }), /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { className: "vrf-list-toolbar" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, fontWeight: 950 } }, listingCountLabel), visibleCity ? /* @__PURE__ */ React.createElement("span", { style: { marginLeft: 8, color: "var(--vrf-muted)", fontSize: 12, fontWeight: 750 } }, " in ", visibleCity) : null), /* @__PURE__ */ React.createElement("div", { className: "vrf-toolbar-actions" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-search-suggest" }, /* @__PURE__ */ React.createElement(
      "input",
      {
        className: "vrf-input",
      ...
      /* @__PURE__ */ React.createElement("img", { src: vehicle.image || fallbackImageForExplorerVehicle(vehicle), alt: "", onError: (event) => {
        event.currentTarget.src = fallbackImageForExplorerVehicle(vehicle);
      } }),
      ...
      item.label,
      " \xD7"
    )), activeFilterItems.length > 0 ? /* @__PURE__ */ React.createElement("button", { type: "button", className: "vrf-link-button", "aria-label": "Clear active vehicle filters", onClick: clearFilters }, "Clear all") : null), filtered.length > 0 ? /* @__PURE__ */ React.createElement("div", { className: "vrf-card-grid", "data-view": viewMode }, visibleVehicles.map((vehicle) => /* @__PURE__ */ React.createElement(
      VrfVehicleCard,
      {
        key: vehicle.id,
        vehicle,
  ...
  function VrfEmiCalculator({ vehicle, onEligibility }) {
    ...
    return /* @__PURE__ */ React.createElement("section", { id: "finance", className: "vrf-section" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-container" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-emi-panel" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-emi-left" }, /* @__PURE__ */ React.createElement("span", { className: "vrf-card-brand", style: { color: "var(--vrf-brand)" } }, "EMI Calculator"), /* @__PURE__ */ React.createElement("h2", { style: { margin: "8px 0 0", fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 4vw, 2.6rem)", lineHeight: 1.08, fontWeight: 950 } }, "Plan your finance with confidence."), /* @__PURE__ */ React.createElement("p", { style: { color: "var(--vrf-muted)", fontSize: 14, fontWeight: 700 } }, "Adjust price, down payment, tenure, and interest rate to fit your budget."), /* @__PURE__ */ React.createElement("div", { className: "vrf-range-row" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 14, fontWeight: 850 } }, /* @__PURE__ */ React.createElement("span", null, "Vehicle price"), /* @__PURE__ */ React.createElement("strong", { style: { color: "var(--vrf-brand)" } }, format(price))), /* @__PURE__ */ React.createElement("input", { type: "range", min: "400000", max: "5000000", step: "50000", value: price, onChange: (event) => setPrice(Number(event.target.value)) })), /* @__PURE__ */ React.createElement("div", { className: "vrf-range-row" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 14, fontWeight: 850 } }, /* @__PURE__ */ React.createElement("span", null, "Down payment"), /* @__PURE__ */ React.createElement("strong", { style: { color: "var(--vrf-brand)" } }, format(Math.min(down, Math.floor(price / 2))))), /* @__PURE__ */ React.createElement("input", { type: "range", min: "0", max: Math.floor(price / 2), step: "10000", value: Math.min(down, Math.floor(price / 2)), onChange: (event) => setDown(Number(event.target.value)) })), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, marginTop: 28 } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 850 } }, "Tenure (years)"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, marginTop: 10 } }, [3, 5, 7].map((item) => /* @__PURE__ */ React.createElement("button", { key: item, type: "button", className: "vrf-chip", "data-active": tenure === item, onClick: () => setTenure(item) }, item)))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 850 } }, "Interest rate"), /* @__PURE__ */ React.createElement("input", { className: "vrf-input", type: "number", step: "0.1", value: rate, onChange: (event) => setRate(Number(event.target.value)), style: { marginTop: 10, textAlign: "center", fontWeight: 950 } })))), /* @__PURE__ */ React.createElement("div", { className: "vrf-emi-result" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { color: "rgb(248 250 252 / 0.62)", fontSize: 12, fontWeight: 950, letterSpacing: "0.1em", textTransform: "uppercase" } }, "Estimated EMI"), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 8, fontFamily: "var(--font-display)", fontSize: "clamp(2.8rem, 5vw, 4rem)", lineHeight: 1, fontWeight: 950 } }, format(result.emi), /* @__PURE__ */ React.createElement("span", { style: { color: "rgb(248 250 252 / 0.5)", fontSize: 20 } }, "/mo"))), /* @__PURE__ */ React.createElement("div", { style: { borderTop: "1px solid rgb(248 250 252 / 0.12)", borderBottom: "1px solid rgb(248 250 252 / 0.12)", padding: "22px 0", display: "grid", gap: 12, fontSize: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "rgb(248 250 252 / 0.62)" } }, "Principal"), /* @__PURE__ */ React.createElement("strong", null, format(result.principal))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "rgb(248 250 252 / 0.62)" } }, "Total interest"), /* @__PURE__ */ React.createElement("strong", null, format(result.interest))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "rgb(248 250 252 / 0.62)" } }, "Total payable"), /* @__PURE__ */ React.createElement("strong", null, format(result.total)))), /* @__PURE__ */ React.createElement("button", { type: "button", className: "vrf-primary", style: { background: "var(--vrf-bg)", color: "var(--vrf-foreground)" }, onClick: () => onEligibility(vehicle, result) }, "Check eligibility ", /* @__PURE__ */ React.createElement(window.Icons.arrowRight, { size: 14, style: { verticalAlign: "-2px" } }))))));
  }
  function VrfTrustBand() {
    ...
    return /* @__PURE__ */ React.createElement("section", { className: "vrf-section vrf-trust" }, /* @__PURE__ */ React.createElement("div", { className: "vrf-container" }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 680, marginBottom: 34 } }, /* @__PURE__ */ React.createElement("span", { className: "vrf-card-brand", style: { color: "var(--vrf-brand)" } }, "Why DealerSite Market"), /* @__PURE__ */ React.createElement("h2", { style: { margin: "8px 0 0", fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 4vw, 2.6rem)", lineHeight: 1.08, fontWeight: 950 } }, "Built for first-time clarity.")), /* @__PURE__ */ React.createElement("div", { className: "vrf-trust-grid" }, items.map(([title, body, icon]) => {
    ...
    React.useEffect(() => {
      ...
      async function loadVehicles() {
        try {
          ...
          const mapped = rows.filter((row) => conditionLabel(row.condition) === "New").map(mapDbVehicleToExplorer).filter(Boolean);
          if (!active) return;
          if (mapped.length > 0) {
  ...
  // public/design-system-handoff/ui_kits/marketing/marketing-entry.jsx
  function DealerSiteMarketingApp() {
    const params = new URLSearchParams(window.location.search || "");
    const initialMode = params.get("mode") === "builder" ? "builder" : "vehicles";
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(window.Header, { step, setStep, mode, setMode }), isVehicleMode ? /* @__PURE__ */ React.createElement(window.VehicleExplorer, { setMode }) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(window.StatsBand, null), /* @__PURE__ */ React.createElement(window.BrandStrip, null), /* @__PURE__ */ React.createElement(window.SearchDiscover, null), /* @__PURE__ */ React.createElement(window.Categories, null), /* @__PURE__ */ React.createElement(window.HowItWorks, null), /* @__PURE__ */ React.createElement(window.Showcase, null), /* @__PURE__ */ React.createElement(window.Leads, null), /* @__PURE__ */ React.createElement(window.BrandDomain, null), /* @__PURE__ */ React.createElement(window.Templates, null), /* @__PURE__ */ React.createElement(window.Testimonials, null), /* @__PURE__ */ React.createElement(window.Pricing, null), /* @__PURE__ */ React.createElement(window.Faq, null), /* @__PURE__ */ React.createElement(window.FinalCTA, null), /* @__PURE__ */ React.createElement(window.Footer, null)), /* @__PURE__ */ React.createElement(window.ExplorerToggle, { mode, setMode }));
  }
  window.DealerSiteMarketingApp = DealerSiteMarketingApp;
  var rootElement = document.getElementById("root");
  if (rootElement) {
    ReactDOM.createRoot(rootElement).render(/* @__PURE__ */ React.createElement(DealerSiteMarketingApp, null));
  }
})();
